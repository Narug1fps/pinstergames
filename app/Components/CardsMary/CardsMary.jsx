                  ...
                  <TypeIt
                    ...
                    getBeforeInit={(instance) => {
                      instance
                        ...
                        ).pause(750).delete(41).pause(500).type("Use sua Luz negra, para descobrir detalhes escondido...E use sua câmera para ver pistas menores.")
            ...
            <div className="bg-white border-4 relative overflow-hidden transition-transform duration-300 ease-in-out rounded-lg shadow-lg group hover:shadow-xl hover:-translate-y-2">
              ...
              <div className="p-4 bg-background">
                ...
                <TypeIt
                    ...
                    getBeforeInit={(instance) => {
                      instance
                        .type("Use as pistas encontradas para preencher a prancheta e progredir.").pause(750).delete(65).pause(500).type(
                          "Responda todas perguntas feitas em sua prancheta para progredir."
                        )
